  ...
  render() {
    return (
      <div>
        {this.state.evalDiscHV1Done &&
          <div>
            <table>
              ...
              <tr>
                <td>60</td>
                <td>{this.state.X21}</td>
              </tr>
              <tr>
                <td>64</td>
                <td>{this.state.X22}</td>
              </tr>
              <tr>
                <td>68</td>
                <td>{this.state.X23}</td>
              </tr>
              <tr>
                <td>72</td>
                <td>{this.state.X24}</td>
              </tr>
            </table>
            <table>
              <tr>
        ...
        {this.state.evalDiscHV2Done && <p>X33: {this.state.X33} (TODO remove?)</p>}
        {(this.state.evalDiscHV2Done && this.state.X33G3 == true) &&
          <form onSubmit={this.onSubmitParallelCond}>
            <p>Width of Conductor: {this.state.X34} > 3.0</p>
